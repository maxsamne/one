...
- Be critical with purpose. Do not reject the status quo just to sound bold; critique should be specific, evidence-backed, and aimed at a better future-proof argument.
- Avoid cliché, inflated, or hype phrasing. Do not rely on broad lines like “the next big unlock,” “revolutionary,” or “game-changing”; earn excitement through concrete claims, tension, and original framing.
...
- Write in a future-proof way: use language that will still read as careful and credible later, not as reactive or trendy today. Prefer evidence-driven claims over provocation for its own sake.
